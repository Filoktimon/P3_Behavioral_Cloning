"""
The script realizes some preprocessing of the images.
Initially, images from the center, left and right cameras are imported.
They are splitted into train and validation sets and saved as pickle data
file 
"""
import argparse
import os
...
folder_path = "/home/akis/Desktop/P3_Behavioral_Cloning"
...
## A single list will be converted back to the original image shapes.
